...
| 5g.2 — PG HA with Patroni + etcd-on-HAProxy | 🔲 | Sub-phases 5g.2.a–5g.2.j. Patroni-managed cluster (Fulla/Vör/Idunn), etcd co-located on HAProxy LXC trio (Hlin/Eir/Snotra at 1133/1134/1135), keepalived VIP `10.0.10.210` floating across the trio. No pgbouncer (documented decision with revisit triggers). Authentik cutover at 5g.2.h retires the IP stopgap. Other planned consumers (Outline, Immich, NetBox, n8n, Zabbix, TeamSpeak) point at the same VIP when each lands. |
